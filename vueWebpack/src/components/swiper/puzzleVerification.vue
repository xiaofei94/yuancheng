...
export default {
	...
	data() {
		return {
			...
			imgRandom: "",
			left_Num: 0,
			dataWidth: null,  //画布图像宽度
			dataHeight: null,  //画布图像高度
			puzzleSize: null, // 滑块的大小
			deviationValue: null, //误差
			radius: null,  //滑块圆角
			padding: null,
			time: null
		};
...
.slider-container .slider-btn {
	...
	.slider-container .slider-btn span{
			width: 2px;
			height: 12px;
			background: #fff;
			display: inline-block;
...
.puzzle-header .puzzle-header-left {
		color: #333;
	}
	.puzzle-header .re-btn,
