<template>
    <div class="">
		<myScroll>
			<!-- <ul class="content"> -->
                <div style="height:50px;text-align:center;background:#fff;margin-bottom:1px" v-for="item in 100">{{item}}</div>
            <!-- </ul> -->
		</myScroll>
       <!-- <div class="container">
...
<script>
import myScroll from '../../components/Bscroll/index.vue'
export default {
    data () {
		 return {
		  list : [
		  {
		   title : 'Chrome更新了' ,
		   imgUrl : 'https://ss0.bdstatic.com/-0U0bnSm1A5BphGlnYG/tam-ogel/596dcc03554a7df640fdbb60f40a4dcd_121_121.jpg' ,
		   tips : '不再支持Flash视频播放' ,
		   time : '上午 8:30'
		  },
		  {
